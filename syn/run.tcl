...
elaborate rca_64bit; # top module name

# store the unmapped results
write -hierarchy -format ddc -output results/rca_64bit.unmapped.ddc
...
source rca_64bit.constraints.tcl
...
check_design > reports/rca_64bit.check_design.rpt; # dump to the file
...
# Write out design
write -format verilog -hierarchy -output results/rca_64bit.mapped.v
write -format ddc -hierarchy -output results/rca_64bit.mapped.ddc
write_sdf results/rca_64bit.mapped.sdf
write_sdc -nosplit results/rca_64bit.mapped.sdc

# Generate reports
report_qor > reports/rca_64bit.mapped.qor.rpt
report_timing -transition_time -nets -attribute -nosplit \
  > reports/rca_64bit.mapped.timing.rpt
report_area -nosplit > reports/rca_64bit.mapped.area.rpt
report_power -nosplit > reports/rca_64bit.mapped.power.rpt
